...
public interface CancelticketService {
		...
		String addCancelticketService(Cancelticket ctRef) throws TicketNumberAlreadyExistsException;  //C - add/create
		...
		String modifyCancelticketService(Cancelticket ctRef) throws TicketNumberNotFoundException; //U - modify/update
		void removeCancelticketService(int cancelid) throws TicketNumberNotFoundException; //D - remove/delete
		String removeDepartmentService(int cancelid);
